...
const FINNHUB_TOKEN = 'd2dd5b1r01qjem5k7hegd2dd5b1r01qjem5k7hf0';
const FINNHUB_URL = 'https://finnhub.io/api/v1/stock/candle';

async function getStockCandle(symbol, resolution, from, to) {
    try {
        ...
        console.error('Error fetching stock candle:', error);
        throw error;
    }
}

// Example usage:
// getStockCandle('IBM', 'D', 1735976651, 1738741451).then(console.log);




const finnhubClient = new finnhub.DefaultApi("d2dd5b1r01qjem5k7hegd2dd5b1r01qjem5k7hf0") // Replace this

// Stock candles
// finnhubClient.stockCandles("OANDA:XAU_USD", "D", 1735976651, 1738741451, (error, data, response) => {
//     console.log(data)
// });
